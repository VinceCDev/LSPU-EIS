...
<head>
    ...
    <title>Admininistrator Profile | LSPU - EIS</title>
                ...
                <div class="relative">
                    ...
                    >
                        <div v-if="profileDropdownOpen" class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-600 rounded-md shadow-lg py-1 z-50 border border-gray-200 dark:border-gray-500 transform origin-top-right">
                            ...
                            <a class="flex items-center px-4 py-2 text-blue-800 dark:text-blue-200 hover:bg-blue-100 dark:hover:bg-blue-500" href="admin_profile">
        ...
        <div class="container-fluid max-w-7xl mx-auto">
            ...
            <section class="relative bg-white dark:bg-gray-700 rounded-xl shadow-sm p-4 sm:p-6 mb-6 overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col items-center text-center">
                    <div class="relative mb-4 sm:mb-6">
                        <img :src="profile.profile_pic || 'images/logo.png'" alt="Profile Photo" class="w-24 h-24 sm:w-40 sm:h-40 rounded-full object-cover border-4 border-white dark:border-gray-300 shadow-lg">
            ...
            <section class="bg-white dark:bg-gray-700 rounded-xl shadow-sm p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        <div class="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase">Department</div>
                        <div class="text-gray-800 dark:text-gray-200 uppercase">{{ profile.department || 'Not specified' }}</div>
                    </div>
                </div>
            </section>
        </div>
                    ...
                    <form @submit.prevent="saveProfile">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" v-model="editForm.position" class="w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Department</label>
                                <input type="text" v-model="editForm.department" class="w-full border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white">
                            </div>
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md mx-2 p-6 relative">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-center">
                            <div class="relative">
                                <img :src="profile.profile_pic || 'images/logo.png'" alt="Current Photo" class="w-32 h-32 rounded-full object-cover border-4 border-gray-200 dark:border-gray-600">
                            </div>
                        </div>
                        <div>
