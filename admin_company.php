...
<head>
    ...
    <title>Companies | LSPU - EIS</title>
...
<body :class="[darkMode ? 'dark' : '', 'font-sans bg-gray-50 dark:bg-gray-800 min-h-screen']" id="app" v-cloak>
        ...
        <div class="overflow-y-auto pt-4 pb-20 h-[calc(100%-64px)] scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100 dark:scrollbar-thumb-slate-600 dark:scrollbar-track-slate-800/50">
            ...
            <div class="mx-2 mb-1">
                ...
                <div class="overflow-hidden transition-all duration-300 ease-in-out" :style="companiesDropdownOpen ? 'max-height: 100px' : 'max-height: 0'">
                    <a href="admin_company" class="block py-2 pl-14 pr-6 mx-2 rounded-lg text-sm text-blue-700 dark:text-blue-300 hover:bg-blue-500/40 dark:hover:bg-blue-500/40 transition-colors duration-200" @click="handleNavClick">Manage Companies</a>
                    ...
                    <table class="min-w-full whitespace-nowrap text-sm text-center data-table">
                        <thead>
                            <tr class="bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-200">
                                ...
                                <th class="px-3 py-2">Name of Company</th>
                                <th class="px-3 py-2">Location</th>
                                <th class="px-3 py-2">Contact Email</th>
                                <th class="px-3 py-2">Industry Type</th>
                                <th class="px-3 py-2">Nature of Business</th>
                                <th class="px-3 py-2">Accreditation Status</th>
                        ...
                        <tbody>
                            <tr v-for="company in paginatedCompanies" :key="company.id" class="border-b border-gray-200 dark:border-gray-600">
                                ...
                                <td class="px-2 py-2 text-gray-700 dark:text-gray-200">{{ company.company_location }}</td>
                                ...
                                <td class="px-2 py-2">
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div v-if="actionDropdown === company.id" class="origin-top-right absolute right-0 mt-2 w-32 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-50 drop-shadow-lg">
                                            <div class="py-1">
                                                <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600" @click.prevent="viewCompany(company)"><i class="fas fa-eye mr-2"></i>View</a>
                                                <a href="#" class="block px-4 py-2 text-sm text-blue-600 hover:bg-blue-100 dark:hover:bg-blue-800" @click.prevent="editCompany(company)"><i class="fas fa-edit mr-2"></i>Edit</a>
                                                <a href="#" class="block px-4 py-2 text-sm text-red-600 hover:bg-red-100 dark:hover:bg-red-800" @click.prevent="confirmDelete(company)"><i class="fas fa-trash-alt mr-2"></i>Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
    ...
    <!-- Add/Edit/View/Delete Modals (structure and design similar to admin_company_pending.php) -->
    <!-- Add Company Modal -->
    ...
    <div v-if="showDeleteModal" class="fixed inset-0 z-[200] flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md mx-2 p-6 relative">
            ...
            <div class="flex justify-end gap-2">
                ...
                <button class="px-4 py-2 rounded bg-red-600 text-white hover:bg-red-700 transition" @click="deleteCompany">Delete</button>
            </div>
        </div>
    </div>
