...
<body :class="[darkMode ? 'dark' : '', 'font-sans bg-gray-50 dark:bg-gray-800 min-h-screen']" id="app" v-cloak>
    ...
    <!-- Rest of your sidebar content remains the same -->
            <div class="overflow-y-auto pt-4 pb-20 h-[calc(100%-64px)] scrollbar-thin scrollbar-thumb-slate-300 scrollbar-track-slate-100 dark:scrollbar-thumb-slate-600 dark:scrollbar-track-slate-800/50">
                ...
                <!-- Accounts -->
                <a href="admin_user" class="flex items-center px-6 py-3 mx-2 rounded-lg bg-blue-500/10 dark:bg-blue-500/20 text-blue-600 dark:text-blue-400 hover:bg-blue-500/20 dark:hover:bg-blue-500/30 transition-colors duration-200 border-l-4 border-blue-500 dark:border-blue-400">
            ...
            <div class="bg-white dark:bg-gray-700 rounded-xl shadow-xl main-shadow p-6">
                        ...
                        <tbody>
                            <tr v-for="account in paginatedAccounts" :key="account.user_id" class="border-b border-gray-200 dark:border-gray-600">
                                <td class="px-4 py-2 text-center">
                                    <img :src="getProfilePic(account)" class="w-12 h-12 rounded-full object-cover border-2 border-blue-500 mx-auto">
                                </td>
                                ...
                                <td class="px-4 py-2 text-center">
                                    <div class="relative inline-block text-left">
                                        ...
                                        <div v-if="actionDropdown === account.user_id" class="origin-top-right absolute right-0 mt-2 w-32 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-10">
                                            <div class="py-1">
                                                <a href="#" class="block px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-600" @click.prevent="viewAccount(account)"><i class="fas fa-eye mr-2"></i>View</a>
                                                <a href="#" class="block px-4 py-2 text-sm text-yellow-600 hover:bg-yellow-100 dark:hover:bg-yellow-800" @click.prevent="openEditModal(account)"><i class="fas fa-edit mr-2"></i>Edit</a>
                                                <a href="#" class="block px-4 py-2 text-sm text-red-600 hover:bg-red-100 dark:hover:bg-red-800" @click.prevent="confirmDelete(account)"><i class="fas fa-trash mr-2"></i>Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-center md:justify-between mt-4 gap-2">
                    <div class="text-gray-600 dark:text-gray-300 text-sm text-center md:text-left w-full md:w-auto flex justify-center md:justify-start">
                        Showing {{ startItem + 1 }} to {{ endItem }} of {{ filteredAccounts.length }} entries
                    </div>
                            ...
                            <form v-if="!roleSelectionStep" @submit.prevent="adminModalMode === 'edit' ? updateAdmin() : addAdminSubmit()">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                                    ...
                                    <div>
                                        ...
                                        <div v-if="adminPhotoPreview" class="flex justify-center mt-2">
                                            <img :src="adminPhotoPreview" alt="Preview" class="w-20 h-20 rounded-full object-cover border-2 border-blue-500">
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-xl mx-2 p-0 relative max-h-[95vh] overflow-y-auto pointer-events-auto">
                        ...
                        <div class="rounded-t-2xl bg-gradient-to-r from-blue-600 via-blue-500 to-blue-400 dark:from-blue-900 dark:via-blue-800 dark:to-blue-700 px-0 pt-6 pb-8 flex flex-col items-center relative">
                            ...
                            <div class="w-28 h-28 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center border-4 border-white dark:border-gray-700 shadow-xl mb-2 mt-2">
                                <img :src="getProfilePic(viewedAccount)" class="w-24 h-24 rounded-full object-cover">
                            </div>
