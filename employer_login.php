...
<head>
    ...
    <title>Employer Login - LSPU EIS</title>
...
<body class="bg-gray-50 font-poppins">
            ...
            <div class="bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden animate-slide-in">
                ...
                <div class="px-6 pb-6">
                    <form @submit.prevent="submitLogin" class="space-y-4">
                        ...
                        <!-- Error Message -->
                        <div v-if="message" :class="['mb-2 p-2 rounded text-center', messageType === 'error' ? 'bg-red-100 text-red-700' : 'bg-green-100 text-green-700']">
                            {{ message }}
                        </div>
                        <!-- Email Field -->
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="email" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-lspu-blue focus:border-lspu-blue transition" 
                                       name="email" placeholder="Enter your email" required v-model="email">
                            </div>
                        </div>
                        <!-- Password Field -->
                        <div class="space-y-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="password" class="w-full pl-10 pr-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-lspu-blue focus:border-lspu-blue transition"
                                       name="password" placeholder="Enter your password" required v-model="password"
                                       @copy.prevent="handleCopy" @paste.prevent="handlePaste" @cut.prevent="handleCut">
                        </div>
                    </div>

                        <!-- Forgot Password Link -->
                        <div class="flex justify-end">
                            <a href="employer_forgot_password" class="text-sm text-lspu-blue hover:text-lspu-dark font-medium transition">Forgot Password?</a>
                        </div>
                        ...
                        <button type="submit" class="w-full px-4 py-2.5 bg-lspu-blue hover:bg-lspu-dark text-white font-semibold rounded-lg shadow-md transition duration-300" :disabled="isLoading">
                            <span v-if="isLoading"><i class="fa fa-spinner fa-spin"></i> Signing in...</span>
                    ...
                    <div class="text-center mt-4 pt-4 border-t border-gray-200">
                        <p class="text-gray-600 text-sm">Don't have an employer account? 
                            <a href="employer_signup" class="text-lspu-blue hover:text-lspu-dark font-medium transition">Register now</a>
                        </p>
                    </div>
                </div>
            </div>
    ...
    <script src="js/employer_login.js"></script>
</body>
</html>